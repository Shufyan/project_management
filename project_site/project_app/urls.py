...
urlpatterns = [    
    ...
    url(r'^project_employee/create/',views.Project_EmployeeCreateView.as_view() ,name='project_employee_create'),
    url(r'^project_employee/(?P<pk>\d+)/delete/$', views.Project_EmployeeDeleteView.as_view(), name='project_employee_delete'),
]